...
def test_domain_analysis(crew):
    ...
    # This is non-trivial
    with patch.object(crew.crew, 'kickoff', return_value={"final_report_key": "mocked_report"}):
...
def test_error_handling(crew):
    ...
    with patch.object(crew.crew, 'kickoff', side_effect=Exception("Test kickoff error")):
        results = crew.run_analysis(user_prompt)

...
1. Client \<-(port)- Proxy (Tells the origin client which port it opened and is accepting UDP frame packets on)
...
1. Client \<--(udp frame) \<-- Proxy \<-- Destination (The destination client responds to the udp packet sent in #3)

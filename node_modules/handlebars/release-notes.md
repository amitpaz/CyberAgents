...
- Build artifacts have been removed from the repository. [npm], [components/handlebars.js][components], [cdnjs], or the [builds page][builds-page] should now be used as the source of built artifacts.
